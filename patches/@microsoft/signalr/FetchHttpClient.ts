...
import toughCookieModule from "tough-cookie";
import nodeFetchModule from "node-fetch";
import fetchCookieModule from "fetch-cookie";
import abortControllerModule from "abort-controller";
...
export class FetchHttpClient extends HttpClient {
    ...
    public constructor(logger: ILogger) {
        ...
        if (typeof fetch === "undefined") {
            ...
            this._jar = new (toughCookieModule).CookieJar();
            this._fetchType = nodeFetchModule as any;

            // node-fetch doesn't have a nice API for getting and setting cookies
            // fetch-cookie will wrap a fetch implementation with a default CookieJar or a provided one
            this._fetchType = fetchCookieModule(this._fetchType, this._jar);
        } else {
